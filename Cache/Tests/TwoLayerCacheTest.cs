...
namespace Redis.Cache.Tests
{
    ...
    class TwoLayerCacheTest
    {
        ...
        public void ShouldNotifyWhenSet()
        {
            ...
            _messageBus.Subscribe("key1", (k, v) => published.Set());
            //When
            _twoLayerCache.Set("key1", "value1");
            //Then
        ...
        [Test]
        public void ShouldInvokeSecondLayerOnce()
        {
            // Given
            _layer1.Remove("key1");
            _layer2.Data["key1"] = "value1";

            // When
            var result1 = _twoLayerCache.Get("key1");
            _layer2.Remove("key1");
            var result2 = _twoLayerCache.Get("key1");
